  ...
  function Category() {
    ...
    //     try {
    //       const info = await axios.get(`/db.json/${category}`);
  ...
  async function fetchProduct() {
    try {
      const info = await axios.get('/db.json'); // Public se direct fetch
      const categoryData = info.data[category] || []; // Specific category ka data
